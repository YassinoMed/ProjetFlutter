...
class ApiConstants {
  ...
  static const String baseUrl = String.fromEnvironment(
    'API_BASE_URL',
    defaultValue: 'http://51.210.243.30:8081/api',
  );
  ...
  static const String baseUrlProd = String.fromEnvironment(
    'API_BASE_URL_PROD',
    defaultValue: baseUrl,
  );
  ...
  static const String wsUrl = String.fromEnvironment(
    'WS_URL',
    defaultValue: 'http://51.210.243.30:6001',
  );
  static const String wsUrlIos = String.fromEnvironment(
    'WS_URL_IOS',
    defaultValue: wsUrl,
  );
  static const String wsUrlWeb = String.fromEnvironment(
    'WS_URL_WEB',
    defaultValue: wsUrl,
  );
  static const String wsUrlProd = String.fromEnvironment(
    'WS_URL_PROD',
    defaultValue: wsUrl,
  );
  ...
  static const String reverbAppKey = String.fromEnvironment(
    'REVERB_APP_KEY',
    defaultValue: 'mediconnect-key',
  );
  static const String reverbAppCluster = String.fromEnvironment(
    'REVERB_APP_CLUSTER',
    defaultValue: 'mt1',
  );
  ...
  static const String geminiDocument = '/gemini/document';
  ...
  static const String callAccept = '/calls/{id}/accept';
  static const String callReject = '/calls/{id}/reject';
