                ...
                return RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      GenUiPromptPanel(
                        sessionId: 'secretary-home-${user?.id ?? 'anonymous'}',
                        role: user?.role ?? AppConstants.roleSecretary,
                        title: 'Brief secrétariat',
                        prompt:
                            'Génère une synthèse de travail pour une secrétaire médicale avec MetricCard, Checklist et ActionButton. '
                            'Respecte les permissions et ne révèle aucune donnée médicale non nécessaire.',
                        contextData: {
                          'screen': 'secretary_home',
                          'delegations': delegations.map((delegation) {
                            return {
                              'doctorName': delegation.doctor?.fullName,
                              'doctorEmail': delegation.doctor?.email,
